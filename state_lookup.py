"""Crosswalk between state name, 2-digit FIPS code, and USPS postal
abbreviation, used to join the CDC (name/FIPS), USGS (FIPS), and EPA
(postal) datasets on a common key.
"""
import pandas as pd

_STATES = [
    ('Alabama', '01', 'AL'), ('Alaska', '02', 'AK'), ('Arizona', '04', 'AZ'),
    ('Arkansas', '05', 'AR'), ('California', '06', 'CA'),
    ('Colorado', '08', 'CO'), ('Connecticut', '09', 'CT'),
    ('Delaware', '10', 'DE'), ('District of Columbia', '11', 'DC'),
    ...
    ('Missouri', '29', 'MO'), ('Montana', '30', 'MT'),
    ('Nebraska', '31', 'NE'), ('Nevada', '32', 'NV'),
    ('New Hampshire', '33', 'NH'), ('New Jersey', '34', 'NJ'),
    ...
    ('Vermont', '50', 'VT'), ('Virginia', '51', 'VA'),
    ('Washington', '53', 'WA'), ('West Virginia', '54', 'WV'),
